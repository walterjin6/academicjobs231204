    ...
    <div className='max-w-screen-2xl mx-auto'>
      ...
      <div className=' max-w-screen-2xl mx-auto'>
        ...
        <div className="region-container bg-white">
          <h2 className="text-2xl font-bold py-3 px-7 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  mx-8">UNITED STATES</h2>
          ...
          <div class="region-container">
            <div>
              <h2 className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">AUSTRALIA</h2>
        ...
        <div>
          <h2 className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">AFRICA</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7  mb-16">
              <ul>
        ...
        <div>
          <h2 className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">ASIA</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
        ...
        <div>
          <h2 className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">CANADA</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
        ...
        <div>
          <h2 className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">UNITED KINGDOM</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
        ...
        <div>
          <h2 className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">SOUTH AMERICA</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
        ...
        <div>
          <h2 className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">NEW ZEALAND</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
        ...
        <div>
          <h2 className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">MIDDLE EAST</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
        ...
        <div>
          <h2 className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">INDIA</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
        ...
        <div>
          <h2 className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">EUROPE</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
