  ...
  return (
    ...
    <div className="">
      <Helmet>
        ...
        <meta name="description" content="Looking for a flexible and rewarding job on campus? Browse hundreds of graduate jobs in various roles and departments at your university. Apply today and gain valuable work experience and skills. " />
      ...
      <div className="blurb text-left py-8 ">
        ...
        <div className="newLine">
          <div className="py-4 px-7 rounded-2xl ">
            ...
            <p >Graduate jobs on campus are temporary or part-time positions in a variety of departments and functions in a university or research institute. These positions give graduates the chance to improve their academic and social networks, earn money, obtain useful work experience, and develop employability skills. Graduate positions on campus can be found in a variety of fields, such as research, teaching, administration, customer service, events, marketing, IT, and libraries. You can locate graduate programs, part-time and casual work, and unique internship possibilities in Australia and throughout the world if you're interested in seeking graduate jobs on campus. You can obtain important work experience and abilities that will benefit you in your future career by applying for these opportunities.  </p>
          </div>
